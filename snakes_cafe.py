...
def greeting():
    print(dedent(f'''
    {'*'*36}\n
    Welcome to the Snakes Cafe!\n To leave this restaurant at any time, type
    quit.\n
    Easy as that...unfortunately\n Here is the menu for tonight. You can type
    in 'menu' again if you would like to see the menu. Or type in any of the
    categories if you would like to see those specific items:\n
    {'*'*36}\n
    '''))
...
def check_input(user_in, item):
    ...
    # if user_in.lower().replace(' ', '') == item['answer']):
    #     item['status'] is True
    #     # feedback(status)
    #     ordering_process()
